...
import (
	"github.com/breezedup/goserver.v2/core/builtin/action"
	...
	"github.com/breezedup/goserver.v2/core/transact"
)
...
func init() {
	transact.RegisteTxCommSkeleton("github.com/breezedup/goserver.v2/srvlib/txcommskeleton", &TxCommSkeleton{})
}
